...
// DEFINICIÓN DE LA FUNCIÓN PARA CONTAR ELEMENTOS
const contarElementos = function (elemento) {
    // OBTENIENDO EL NÚMERO DE ETIQUETAS DEL TIPO ESPECIFICADO EN EL DOCUMENTO HTML
    ...
    alert("Revise la consola del navegador para ver los elementos encontrados.");
};
